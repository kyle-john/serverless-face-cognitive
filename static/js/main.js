;(function () {
    ...
    var registerPhotoTrigger = function () {
        ...
        document.getElementById("register-snap").addEventListener("click", function() {
            ...
            var url = 'https://funtionapptest.azurewebsites.net/' + '/api/register?name=' + document.getElementById("fullname").value;
            $.ajax({
                type: 'POST',
                url: url,
                headers: {
    ...
    var takePhotoTrigger = function () {
        ...
        document.getElementById("login-snap").addEventListener("click", function() {
            ...
            var url = 'https://funtionapptest.azurewebsites.net/api/query';
            $.ajax({
                type: 'POST',
                url: url,
                headers: {
